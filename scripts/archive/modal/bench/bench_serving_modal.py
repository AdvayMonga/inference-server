...
can grow and we find the saturation point + max throughput within SLO.
    ...
    venv/bin/modal run --detach scripts/bench/bench_serving_modal.py            # full sweep
    BENCH_RATES=8,32 BENCH_DURATION=8 venv/bin/modal run scripts/bench/bench_serving_modal.py  # smoke
...
# miss-heavy curve; scripts/bench/bench_stress_modal.py covers the miss + overload case directly.
